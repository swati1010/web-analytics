...
<!--                 <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">Offer of the day</a>  <a href="#">Get flat 35% off on orders over $50!</a>
 ...
 _________________________________________________________ -->
   ...
   if(rsb.next()){
	 request.getRequestDispatcher("Cancel_product_get?id="+id).forward(request,response);
   }
   else{
	   %>
	   <center>
  <h2>Bank Detail</h2>
  <form action="Bank_detail" method="post">
  <table style="width: 34% !important;" class="table table-bordered table-striped">
<tr>
	<td>Bank Name</td>
	<td><input type="text" style="width: 436px;" name="bnk_name"></td>	
</tr>
<tr>
	<td>Name</td>
	<td><input type="text" style="width: 436px;" name="name"></td>	
</tr>
<tr>
	<td>A/c No.</td>
	<td><input type="text"  onkeypress="javascript:return isNumber(event)" style="width: 436px;" name="ac"></td>	
</tr>
<tr>
	<td>IFSC Code</td>
	<td><input type="text" style="width: 436px;" name="ifsc"></td>	
</tr>
<tr>
