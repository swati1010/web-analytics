        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
           ...
           <div class="control-group">
              ...
              <div class="controls">
                <select class="sel" required="required" name="pid" onchange="location = this.value;">
                   		<option value="">Select-Product</option>
						 <option value="select_product_for_dis.jsp?p_type=1">Mobile</option>
						 <option value="select_product_for_dis.jsp?p_type=2">Headphone</option>
						 <option value="select_product_for_dis.jsp?p_type=3">Speaker</option>
						 <option value="select_product_for_dis.jsp?p_type=4">Laptop</option>
						 <option value="select_product_for_dis.jsp?p_type=5">Printer</option>
						</select>
              </div>
            </div>
