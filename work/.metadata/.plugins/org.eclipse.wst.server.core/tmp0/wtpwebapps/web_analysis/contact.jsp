...
<!--                 <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">Offer of the day</a>  <a href="#">Get flat 35% off on orders over $50!</a>
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" >
                        ...
                        <div id="map" style="margin-top: -38em !important;margin-left:2em !important ;">
                        ...
                        <form method="post" action="Send_enq">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="firstname">Name</label>
                                        <input type="text" required="required" class="form-control" name="fname" id="firstname">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="<%=email %>" required="required" class="form-control" name="email" id="email">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="subject">Subject</label>
                                        <input type="text" required="required" class="form-control" name="subject" id="subject">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="lastname">Mobile</label>
                                        <input type="text" required="required" class="form-control" name="lname" ID="tbNumbers" value="" runat="server" 
            onkeypress="javascript:return isNumber(event)" required="required">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="message">Message</label>
                                        <textarea id="message" required="required" name="message" class="form-control"></textarea>
                                    </div>
                                </div>
								
                                <div class="col-sm-12 text-center">
                                    <button type="submit"  class="btn btn-primary" onclick="return ValidateNo();"><i class="fa fa-envelope-o"></i> Send message</button>
