...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="viewallproducts.jsp"><i class="icon icon-signal"></i> <span>View All Products</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="adminindex.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current"> Products</a></div>
  </div>
<!--End-breadcrumbs-->
<%
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              %>
                <tr class="odd gradeX">
                  <td><a href="viewsingleproduct.jsp?productid=<%=rs.getString("productId")%>"><%=rs.getString("productId") %></a></td>
                  <td><%=rs.getString("title") %></td>
                  <td><%=rs.getString("description") %></td>
                  <td><%=rs.getString("mrp") %></td>
                  <td><%=rs.getString("price") %></td>
                  <form action="updatestock.jsp?productid=<%=rs.getString("productId")%>" method="post">
                   <td>
                  <%if(rs.getString("inStock").equals("TRUE"))
                	  {%>
                 <div class="control-group">
              <div class="controls">
                <label>
                  <input type="radio" name="stock" value="TRUE" checked="checked">
                  Yes</label>
                 <label>
              ...
              <div class="controls">
                <label>
                  ...
                  Yes</label>
                 <label>
                  <input type="radio" name="stock" value="FALSE" checked="checked">
                  No</label>
              </div>
            </div></td>
                  <%} %>
                  <td><div class="form-actions">
              <button type="submit" class="btn btn-success"><i class="icon icon-repeat"></i></button>
            </div></td>
            </form>
                </tr>
                <%} %>
