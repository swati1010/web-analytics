...
ResultSet rs3=psa.executeQuery();
if(rs3.next()){
	...
	%>
                    ...
                    <div class="box">
                        <form method="post" action="update_address.jsp">
                            <h1>Checkout</h1>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="lastname">Name</label>
                                                <input type="text" value="<%=rs3.getString("name") %>" class="form-control"  required="required" placeholder="" id="billing_first_name" name="name">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" required="required" cols="50" value="" placeholder="Street address" id="billing_address_1" name="address" class="form-control"><%=rs3.getString("address") %></textarea>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" value="<%=rs3.getString("city") %>" required="required" placeholder="Town / City" id="billing_city" name="city" class="form-control">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="company">Postcode</label>
                                                <input type="text" required="required" runat="server" onkeypress="javascript:return isNumber1(event)" value="<%=rs3.getString("pin") %>" placeholder="Postcode / Zip" id="billing_postcode" name="pin" required="required" class="form-control">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="street">Email</label>
                                                <input type="email" required="required" value="<%=rs3.getString("email") %>" placeholder="" id="billing_email" name="email" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                           ...
                                           <input type="text" required="required" ID="tbNumbers"  runat="server" 
            onkeypress="javascript:return isNumber(event)"  value="<%=rs3.getString("phone") %>" name="phone" class="form-control">
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="submit"  onclick="return ValidateNo();" class="btn btn-primary">Continue to Delivery Method<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
