...
<h1>Checkout</h1>
 ...
 <div class="content">
 <br><br><br><br>
<table style="width: 76% !important;" class="table table-bordered table-striped">
<tr>
	<td>name</td>
	<td>address</td>
	<td>phone</td>
...
if(rsa.next()){
	...
	<td><%=rsa.getString("phone") %></td>
		<td><a href="edit_address.jsp?uid=<%=userid%>">Update</a></td>
	
	
	
</tr> </table>
 <a href="checkout3.jsp" class="btn btn-default"><i class="fa fa-chevron-left"></i>Continue to Delivery Method</a>
	...
	%>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="lastname">Name</label>
                                                <input type="text" value="" class="form-control"  required="required" placeholder="" id="billing_first_name" name="name">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" required="required" cols="50" value="" placeholder="Street address" id="billing_address_1" name="address" class="form-control"></textarea>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" value="" required="required" placeholder="Town / City" id="billing_city" name="city" class="form-control">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="company">Postcode</label>
                                                <input type="text" required="required" runat="server" onkeypress="javascript:return isNumber1(event)" value="" placeholder="Postcode / Zip" id="billing_postcode" name="pin" required="required" class="form-control">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="street">Email</label>
                                                <input type="email" required="required" value="<%=email %>" placeholder="" id="billing_email" name="email" class="form-control">
            ...
            onkeypress="javascript:return isNumber(event)"  placeholder=""  name="phone" class="form-control">
