...
String src=request.getParameter("search");
                 ...
                 int idis=0;
                 String af="";
		PreparedStatement ps = con.prepareStatement("select * from product where title like '%"+src+"%'");
 ...
 <div class="col-md-4 col-sm-6">
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.jsp?prodId=<%=rs.getString("productId")%>">
                                ...
                                <a href="detail.jsp?prodId=<%=rs.getString("productId")%>" class="invisible">
                                    <img src="img/product1.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                                    <h3><a href="detail.jsp?prodId=<%=rs.getString("productId")%>"><%=rs.getString("title") %></a></h3>
                                    <p class="price"><ins>&#8377;<%=rs.getString("price") %><ins style="color: red;">&#8377;<%=idis%>%off</ins></ins> <del>&#8377;<%=af %></del></p>
                                    <p class="buttons">
                                        <a href="detail.jsp?prodId=<%=rs.getString("productId")%>" class="btn btn-default">View detail</a>
                                        <a href="addtocart.jsp?prodId=<%=rs.getString("productId")%>&userid=<%=userid %>&cname=<%=uname %>&email=<%=email %>&p_type=<%=rs.getString("p_type") %>&price=<%=rs.getString("price") %>&qty=1&shipping=0" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                    </p>
                                </div>
                                <!-- /.text -->
                            </div>
