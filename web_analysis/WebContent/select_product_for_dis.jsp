...
<body>
<%
int pid=Integer.parseInt(request.getParameter("p_type"));
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="sortedreviews.jsp"><i class="icon icon-th"></i> <span>Sorted Reviews</span></a></li>
     <li class="active"><a href="setdiscount.jsp"><i class="icon icon-th"></i> <span>Set Discount</span></a></li>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
           <form action="SetDiscount" method="post" class="form-horizontal">
           <div class="control-group">
              ...
              <div class="controls">
                ...
                PreparedStatement ps = con.prepareStatement("select * from product where p_type='"+pid+"' ");
                ResultSet rs = ps.executeQuery();
                while(rs.next())
                {
                %>
                  <option><%=rs.getString("productId") %></option>
                  <%} %>
                </select>
              </div>
            </div>
       <!--  <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Product Title" name="pid"/>
              </div>
            </div> -->
            <div class="control-group">
              <label class="control-label">Set Discount :</label>
              <div class="controls">
                <input type="text"  onkeypress="javascript:return isNumber(event)" required="required" class="span11" placeholder="Discount %" name="pdesc"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">From Date :</label>
              <div class="controls">
                <input type="date" class="span11" required="required" placeholder="From Date" name="fdate"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">To Date :</label>
              <div class="controls">
                <input type="date" class="span11" required="required" placeholder="To Date" name="tdate"/>
              </div>
            </div>
