        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="img/h4-slide.png" alt="" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/h4-slide4.png" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/h4-slide3.png" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/h4-slide7.png" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
...
<%
PreparedStatement psd=con.prepareStatement("select * from product limit 20");
...
%>
                        <div class="item">
                            <div class="product">
                                ...
                                <a class="invisible"  href="detail.jsp?prodId=<%=rs.getString("productId")%>">
