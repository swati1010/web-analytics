...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li><a href="adminindex.jsp"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
     <li class="active"> <a href="addproduct.jsp"><i class="icon icon-signal"></i> <span>Add New Products</span></a> </li>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="control-group">
              ...
              <div class="controls">
                <input type="text" required="required" class="span11" placeholder="Product ID" name="pid"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Title :</label>
              <div class="controls">
                <input type="text"  required="required" class="span11" placeholder="Title" name="ptitle"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Description :</label>
              <div class="controls">
                <input type="text"  required="required" class="span11" placeholder="Description" name="pdesc"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Link of Image</label>
              <div class="controls">
                <input type="text"  required="required" class="span11" placeholder="Link of Image" name="limg"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">MRP :</label>
              <div class="controls">
                <input type="text" class="span11"  required="required" placeholder="MRP" name="mrp" runat="server" 
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  required="required" class="span11" placeholder="Price" name="price" runat="server" 
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Categories" name="pcat"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Brand :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Brand" name="pbrand"/>
              </div>
            </div>
             <div class="control-group">
              <label class="control-label">Product-Type :</label>
              <div class="controls">
                <select required name="p_type" class="span11">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  <input type="radio" name="cod" value="TRUE">
                  Yes</label>
                 <label>
                  <input type="radio" name="cod" value="FALSE">
                  No</label>
              </div>
            </div>
